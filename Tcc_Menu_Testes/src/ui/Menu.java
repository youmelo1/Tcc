...
public class Menu {
	...
	public void menu() {
		...
		while(esc!=6) {
			...
			case 2:
				System.out.println("Digite o código da pessoa que deseja calcular o IMC?");
				o.info();
			...
			case 3:
				System.out.println("Digite o código da pessoa que deseja calcular a taxa de gordura?");
				o.info();
			...
			case 4:
				System.out.println("Digite o código da pessoa que deseja calcular o peso ideal?");
				o.info();
